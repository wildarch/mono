...
^bb0(%0: !physicalplan<block block<i64, i64>> ):
    ...
    %3 = physicalplan.compute %2 : block<i64, i64, i1> -> block<i64, i64, i1, i1> {
    ^bb0(%a:i64, %b:i64, %c:i1):
        %d = arith.cmpi slt, %a, %b : i64
        physicalplan.compute.return %d : i1
    }
    %4 = physicalplan.filter %3 : block<i64, i64, i1, i1> 3
    physicalplan.write_array %4 : block<i64, i64, i1, i1> 
        columns [3] 
        to [0xDEADBEEF3] 
        offptr 0xDEADBEEF4
        capacity 1024
