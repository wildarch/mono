...
## System Design
Ideas from existing systems:
- Content-addressable storage, using sha256 for hashing.
- Starlark for defining build rules (`DABU.star`)

Key ideas:
- Docker images for build environments.
  This avoids complex toolchain rules at the cost of some non-determinism.
