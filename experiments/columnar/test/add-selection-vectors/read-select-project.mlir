...
columnar.query {
  ...
  // CHECK: %6 = columnar.read_table "lineitem" "l_quantity" : <!columnar.dec>
  // CHECK: %7 = columnar.read_table "lineitem" "l_extendedprice" : <!columnar.dec>
  // CHECK: %8 = columnar.read_table "lineitem" "l_discount" : <!columnar.dec>
  // CHECK: %9 = columnar.read_table "lineitem" "l_shipdate" : <!columnar.date>
