...
-- CHECK: %0 = columnar.read_column #column_region_r_regionkey
-- CHECK: %1 = columnar.read_column #column_region_r_name
-- CHECK: %2 = columnar.read_column #column_region_r_comment
